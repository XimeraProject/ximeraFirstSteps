...
\begin{description}
  \item[\textbackslash activity] This is for Ximera documents that \textbf{include a title,
      abstract, and \textbackslash maketitle}. They will be represented by their title
    online. This command is typically used for worksheets and sections of
    textbooks.
  \item[\textbackslash practice] This is for Ximera documents that \textbf{do not include the
      content listed above}. They will be represented by a number  based on the order
    in the list  online. This command is used for lists of exercises and problem
    banks.
\end{description}
...
The purpose of a preamble is to ensure all files compile consistently. It is not for cosmetic changes.
...
\texttt{basics} that
contains the Ximera document \texttt{aFirstStepInXimera.tex}. However, when
this document is compiled via a \verb!xourse! document, the
