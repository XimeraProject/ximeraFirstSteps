...
\begin{warning}
  Cosmetic changes to Ximera environments will result in unpredictable behavior online.
\end{warning}
...
Once you have your preamble, all Ximera files need to be able to access it.
\begin{center}%%DIAGRAM OF FILE STRUCTURE
  \scalebox{.7}{
    \begin{tikzpicture}
      % Define styles for nodes
...
\end{verbatim}
With this said, modifying input paths is more of an advanced feature that we will discuss later.
\end{document}
