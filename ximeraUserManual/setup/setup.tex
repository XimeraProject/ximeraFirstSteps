...
\end{center}
The \verb!xourse! documentclass specifies information such as the name of the document, the names fo the authors, a description of
the content, and the names of all \LaTeX\ activity files comprising the document.
...
An activity should be composed as a regular \LaTeX\ file in the documentclass
