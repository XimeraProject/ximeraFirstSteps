...
\begin{center}
  \includegraphics[width=5cm]{missionPatch.jpg}
\end{center}
The image, also used in \texttt{ximeraFirstSteps}, is in the folder \texttt{basics} that
contains the Ximera document \texttt{aFirstStepInXimera.tex}. However, when this document is compiled via a \verb!xourse! document, the
