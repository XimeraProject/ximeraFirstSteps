...
\begin{center}
    \url{https://github.com/ximeraProject/ximeraFirstSteps/basics/basicWorksheet.tex}
\end{center}
...
\begin{prompt} %% The content within prompt is not necessary in a PDF or physical handout
\[
