...
You could clone the https://github.com/XimeraProject/ximeraFirstSteps.git repo, and then you will not be able to push your changes.
But this will not be needed to get familiar with Ximera, and test the setup on your local device.

If you forked the repo, you should clone  **your copy** of ximeraFirstSteps.
...
The new buttons will be named "PDF," "HTML," "Bake," "Serve," and "Extra".

## PDF/HTML/Bake 

If you open one .tex file, e.g. by typing CTRL-P and typing/selecting basicWorksheet.tex, you can compile it to a PDF by selecting the 'PDF' button
at the right bottom of your screen. Similarly, an HTML version is generated by selecting the 'HTML' button.

The very first time you push any  the button a docker image will automatically e downloaded. It's very large, several gigabytes, and will take time.
Later compilations will be much faster.

If you press the "Bake" button, **all** files will be compiled to HTML. The very **first** time it will compile all the documents, and this will take some time. However, the next time you compile, it will only compile updated files and will be **much** faster.
